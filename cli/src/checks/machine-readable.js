...
export function checkMachineReadability(scope, allFiles) {
    const checks = [];
    ...
    let formattedPriceFile;
    let formattedPriceLine;
    ...
    checks.push({
        ...
        fix: catalogueFiles.length > 0 && !sawSkuField
...
function safeRead(scope, relativePath) {
    try {
...
//# sourceMappingURL=machine-readable.js.map