  ...
  return (
    <div className="relative z-10 w-full max-w-[480px] flex flex-col items-center">
      ...
      <p className="text-[15px] mb-10 text-center" style={{ color: "#888" }}>
        ...
        <Link href="/login" className="font-medium transition-opacity hover:opacity-80 underline underline-offset-4 decoration-[#666]" style={{ color: "#fff" }}>
          Log in.
        </Link>
      </p>
      ...
      >
        ...
        {/* Form */}
        <form action={signup} className="w-full space-y-5">
          {/* Business name */}
          <div className="flex flex-col gap-2">
            <label className="text-[13px] font-medium tracking-wide" style={{ color: "#aaa" }}>Business name</label>
            <input
              name="name"
              required
              autoComplete="organization"
              placeholder="Fourth man"
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[11px]" style={{ color: "#777" }}>At least 8 characters.</span>
            </div>
            <input
              name="password"
              type="password"
