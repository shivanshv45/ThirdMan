...
export function robotsBlocksAgents(robotsContent: string): boolean {
...
export function sitemapReferencesProducts(sitemapContent: string): boolean {
...
export function hasProductStructuredData(pageContent: string): boolean {
  return (
    pageContent.includes("schema.org/Product") ||
...
export function hasStableItemIdentifier(pageContent: string): boolean {
...
export function checkoutRequiresHumanOnlyStep(checkoutContent: string): boolean {
...
export function priceLooksLikeFormattedString(content: string): boolean {
...
export function hasSkuField(content: string): boolean {
